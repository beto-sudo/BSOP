 ...
 * metadata (Record<string, any>) that crosses Supabase JSON boundaries; proper
 * typing requires a schema-wide refactor. set-state-in-effect is flagged by
 * the new React hook rules for data-sync patterns here; rewriting them would
 * change render behavior and is out of scope for a bulk lint cleanup.
 */
