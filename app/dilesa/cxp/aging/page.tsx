...
/**
 * CxP · Saldos (DILESA) — wrapper delgado del módulo compartido (ADR-011, SM1).
 *
...
export default function CxpAgingPage() {
  return (
    <RequireAccess empresa="dilesa" modulo="dilesa.cxp.aging">
      <CxpAgingModule empresaId={DILESA_EMPRESA_ID} />
    </RequireAccess>
  );
}
