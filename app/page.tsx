      ...
      <section className="grid gap-6">
        <Surface className="p-8 sm:p-12">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-white/62 sm:text-base">
            Bienvenido al panel central de operaciones. Desde aquí puedes monitorear y gestionar los
            módulos activos de tus empresas.
          </p>
        </Surface>
      </section>
      ...
      <section className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Surface className="flex flex-col p-6">
          ...
          <div className="mt-6">
            <Link
              href="/dilesa"
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-500/10 px-4 py-2.5 text-sm font-medium text-blue-400 transition hover:bg-blue-500/20"
            >
              Ir a DILESA
        ...
        <Surface className="flex flex-col p-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-2">
            <Link
              href="/rdb/cortes"
              className="flex items-center justify-between rounded-xl bg-white/5 px-3 py-2 text-xs font-medium text-white transition hover:bg-white/10"
            >
              <span className="flex items-center gap-2">
                <Wallet className="h-3.5 w-3.5 text-white/50" /> Cortes
              </span>
            </Link>
            <Link
            ...
            >
              <span className="flex items-center gap-2">
                <Boxes className="h-3.5 w-3.5 text-white/50" /> Compras
              </span>
            </Link>
          </div>
        </Surface>
        ...
        <Surface className="flex flex-col p-6">
          ...
          <div className="mt-6">
            <Link
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--accent)]/10 px-4 py-2.5 text-sm font-medium text-[var(--accent-soft)] transition hover:bg-[var(--accent)]/20"
            >
              Gestionar accesos
              <ArrowRight className="h-4 w-4" />
            </Link>
