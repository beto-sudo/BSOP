...
// Vista read-only del historial de recepciones para el drawer de OC. La
// captura (recibir N / cancelar pendiente) vive solo en /rdb/recepciones desde
// la iniciativa `oc-recepciones-modulo`; aquí queda la información para que
// el Comprador/Director vea qué se recibió, cuánto vale, en qué almacén y
// el progreso vs el total estimado, sin poder mutar.
    ...
    >
      <DetailDrawerContent>
        ...
        <div className="space-y-6 print:space-y-4">
          ...
          {/* ── Historial de recepciones (read-only post-envío) ─── */}
          {/* La captura (recibir / cancelar pendiente) vive en /rdb/recepciones
              desde la iniciativa `oc-recepciones-modulo`; aquí queda la
              información para que el dueño del módulo OC vea qué se recibió,
              cuánto vale, en qué almacén y el progreso, sin poder mutar. */}
          {!editable && orden?.id && (
            <RecepcionesHistorial
              ordenId={orden.id}
              movs={recepcionMovs}
