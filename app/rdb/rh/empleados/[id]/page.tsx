        ...
        {editing ? (
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <Input value={emailEmpresa} onChange={(e) => setEmailEmpresa(e.target.value)} placeholder="nombre@rdb.com" className="rounded-xl border-[var(--border)] bg-[var(--panel)] text-[var(--text)]" />
            </div>
            <div>
