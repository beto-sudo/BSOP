                ...
                <div className="grid gap-4">
                  <div className="rounded-3xl border border-white/8 bg-white/4 p-5">
                    <div className="mb-3 flex items-center gap-2 text-sm font-medium text-white">
                      <MapPin className="h-4 w-4 text-amber-300" /> Ubicación
                    </div>
                  ...
                  <div className="rounded-3xl border border-white/8 bg-white/4 p-5">
                    <div className="mb-3 flex items-center gap-2 text-sm font-medium text-white">
                      <Wallet className="h-4 w-4 text-amber-300" /> Presupuesto
                    </div>
                    <div className="text-sm text-white/60">Escenario cómodo</div>
                    <div className="mt-2 text-2xl font-semibold text-white">
                      {trip.budgetSummary.comfortable}
                    </div>
                    <div className="mt-1 text-sm text-white/50">
                      {trip.budgetSummary.perPersonComfortable} por persona
                    </div>
                  </div>
                  <div className="rounded-3xl border border-white/8 bg-white/4 p-5">
                    <div className="mb-3 flex items-center gap-2 text-sm font-medium text-white">
                      <Users className="h-4 w-4 text-amber-300" /> Participantes
                    </div>
                    <div className="text-lg font-semibold text-white">
                      {trip.travelers} viajeros
                    </div>
                    <p className="mt-2 text-sm leading-6 text-white/55">
                      {trip.travelerNames.join(' · ')}
                    </p>
                  </div>
                  <div className="rounded-3xl border border-white/8 bg-white/4 p-5">
                    <div className="mb-3 flex items-center gap-2 text-sm font-medium text-white">
                      <Route className="h-4 w-4 text-amber-300" /> Formato
                    </div>
