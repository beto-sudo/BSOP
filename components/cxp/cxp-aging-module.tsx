...
/**
 * CxP · Saldos — módulo compartido cross-empresa (ADR-011, SM1-SM6).
 *
 ...
 * 100% derivado client-side, sin captura. Gemelo de `cobranza/aging`.
 *
...
export type CxpAgingModuleProps = {
...
export function CxpAgingModule({ empresaId }: CxpAgingModuleProps) {
