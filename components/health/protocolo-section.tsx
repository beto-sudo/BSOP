...
/**
 * Vistazo read-only del protocolo en Health (péptidos/suplementos): dosis vigente,
 * última toma y mini-timeline. La CAPTURA vive ahora en SANREN → Péptidos →
 * Bitácora (decisión D2 de sanren-peptides); aquí solo se muestra. El overlay con
 * biomarcadores (peso/RHR/HRV/BP) llega en el Sprint 4 de salud-protocolo.
 */
    ...
    <section className="mt-10">
      <div className="mb-4">
        ...
        <p className="mt-2 text-sm text-[var(--muted-foreground)] dark:text-white/55">
          Lo que te estás administrando y su dosis vigente. Registra tus tomas en{' '}
          <Link
            href="/peptides?tab=bitacora"
            className="text-emerald-600 hover:underline dark:text-emerald-300"
          >
            SANREN → Péptidos → Bitácora
          </Link>
          . El cruce con peso, pulso en reposo y presión llega en una próxima fase.
        </p>
      </div>
