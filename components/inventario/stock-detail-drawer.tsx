  ...
  return (
    ...
    >
      ...
      <DetailDrawerContent>
        ...
        {item.bajo_minimo && (
          <div className="mt-3 flex items-center gap-2 rounded-lg border border-amber-500/30 bg-amber-500/10 px-3 py-2.5 text-sm text-amber-600 dark:text-amber-400">
            <AlertTriangle className="h-4 w-4 shrink-0" />
            Stock por debajo del mínimo
          </div>
        )}

        <DetailDrawerSection title="Historial de movimientos">
          {loading ? (
