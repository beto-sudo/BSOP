...
export function ExpenseList({
  ...
  return (
    <Surface className="p-6">
      ...
      {!hasSupabase ? <div className="mt-6 rounded-2xl border border-amber-300/20 bg-amber-300/10 px-4 py-4 text-sm text-amber-100">Faltan variables de entorno de Supabase. Agrega `.env.local` y las variables en Vercel.</div> : null}
