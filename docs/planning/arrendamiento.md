...
**Estado:** planned
**Próximo hito:** Arrancar **S1 reducido** (schema + alta + filtros de cobranza, sin tocar la RPC de ventas). No bloqueante: una factura real de espectacular para calibrar el default fiscal; lista de backfill.
**Dueño:** Beto
**Creada:** 2026-06-26
