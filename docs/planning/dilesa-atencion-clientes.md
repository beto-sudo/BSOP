...
**Estado:** planned
**Próximo hito:** Sprint 1 completo en PR #906 de revisión — backend (S1a/S1b/S1c/**S1d candados**) ✅ en prod + **UI** (programar → checklist → acta firmada → recibida, con avance previo como candado). Falta: Beto/Ciori prueban en el Vercel Preview y mergean; luego Sprint 2 (bandeja de Atención a Clientes). La redistribución de % y la unificación de nombres en DB quedan diferidas a arranques nuevos.
**Dueño:** Beto
**Creada:** 2026-06-15
