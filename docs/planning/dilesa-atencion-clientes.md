...
**Estado:** in_progress
**Próximo hito:** Sprint 1 (recepción de obra) ✅ en prod. **Sprint 2 — bandeja de Atención a Clientes** en PR de revisión: módulo nuevo `dilesa.atencion_clientes` (sidebar) + 4 colas (obras por recibir / pre-entrega / entrega / encuesta) sobre 3 vistas. Falta: Beto/Ciori prueban en Preview y mergean → con eso la iniciativa queda **funcionalmente completa** (quedan opcionales: KPIs del depto y la deuda diferida de % en arranques nuevos). La redistribución de % y la unificación de nombres en DB siguen diferidas a arranques nuevos.
**Dueño:** Beto
**Creada:** 2026-06-15
**Última actualización:** 2026-06-16 (Sprint 2 en PR de revisión — bandeja de Atención a Clientes)
