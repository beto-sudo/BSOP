...
**Estado:** planned
**Próximo hito:** Backend de S1a/S1b/S1c ✅ aplicado a prod (2026-06-16): marca `hito_recepcion`, tabla `recepcion_obra`, RPC `fn_recepcion_cerrar`, trigger + sub-slug RBAC. Sigue la **UI** (botón "Recibir obra" + drawer de checklist + label canónico) y definir el **contenido del checklist** con Ciori. La redistribución de % y la unificación de nombres en DB quedan diferidas a arranques nuevos.
**Dueño:** Beto
**Creada:** 2026-06-15
