...
**Estado:** done
**Próximo hito:** — (cerrada). Ciori opera el tramo completo en BSOP: recibe la obra (candados + acta firmada), prepara/entrega la vivienda y cierra la conformidad, todo desde su bandeja con KPIs. Deuda diferida (no bloquea): estandarizar el % del bloque de cierre (~6%) en arranques nuevos.
**Dueño:** Beto
**Creada:** 2026-06-15
**Última actualización:** 2026-06-16 (Sprint 3 KPIs + cierre — iniciativa done)
