...
**Estado:** in_progress
**Próximo hito:** mergear el fix del valor real legacy ([PR #1057](https://github.com/beto-sudo/BSOP/pull/1057)) → correr el backfill de las 940 ventas (pendiente OK explícito de Beto)
**Dueño:** Beto
**Creada:** 2026-06-26
**Última actualización:** 2026-06-26 (Sprint 1 mergeado [#1053]; fix del valor real legacy en [#1057]; backfill pendiente correr post-merge)
