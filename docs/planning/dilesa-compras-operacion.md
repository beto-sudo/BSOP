...
**Estado:** in_progress
**Próximo hito:** **Sprint 2b (PDF de la OC) en revisión de Beto** ([#1020](https://github.com/beto-sudo/BSOP/pull/1020), sin auto-merge — UI). Sigue **Sprint 3** (enviar la OC por email al proveedor + PDF del cuadro comparativo de la RFQ + envío masivo de la solicitud). Sprints 0/1/2a ya mergeados.
**Dueño:** Beto
**Creada:** 2026-06-24
**Última actualización:** 2026-06-24 (Sprint 2: folio secuencial `OC-2026-NNNN` aplicado a prod — #1019 mergeado; PDF de la OC en #1020 en revisión)
