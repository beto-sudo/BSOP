...
**Estado:** in_progress
**Próximo hito:** **Sprint 5b (adjudicación reversible + cascade de cancelación) en revisión de Beto.** Sigue: 5c folio secuencial de RFQ + data-fix del caso REQ-MQSAD18S. (Pendiente de Beto aparte: Sprint 3b — cuadro comparativo de RFQ + envío masivo.) Sprint 5a (#1035) mergeado.
**Dueño:** Beto
**Creada:** 2026-06-24
