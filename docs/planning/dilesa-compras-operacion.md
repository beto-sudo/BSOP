...
**Estado:** in_progress
**Próximo hito:** **Sprint 5a (pulido del flujo) en revisión de Beto** — candado de una RFQ por requisición (resuelve el caso REQ-MQSAD18S). Sigue: 5b adjudicación reversible + bloqueo de cancelación + 5c folio RFQ + data-fix del caso. (Pendiente de Beto aparte: Sprint 3b — cuadro comparativo de RFQ + envío masivo.)
**Dueño:** Beto
**Creada:** 2026-06-24
**Última actualización:** 2026-06-25 (arranca Sprint 5 «Pulido del flujo RFQ/cancelación»: candado de una RFQ por requisición; Sprints 0-3a mergeados)
