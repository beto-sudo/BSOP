...
**Estado:** in_progress
**Próximo hito:** **Sprint 5b (adjudicación reversible + cascade de cancelación) en revisión de Beto.** Sigue: 5c folio secuencial de RFQ (toca schema, con OK de Beto). Data-fix del caso REQ-MQSAD18S: **hecho en prod** (reabierta la adjudicada, canceladas las 2 duplicadas vacías). (Pendiente de Beto aparte: Sprint 3b — cuadro comparativo de RFQ + envío masivo.) Sprint 5a (#1035) mergeado.
**Dueño:** Beto
**Creada:** 2026-06-24
**Última actualización:** 2026-06-25 (Sprint 5b: adjudicación reversible — cancelar OC reabre su RFQ — + cascade al cancelar requisición; Sprint 5a #1035 mergeado)
