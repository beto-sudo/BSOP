...
**Estado:** in_progress
**Próximo hito:** **Sprint 1 en revisión de Beto** ([#1018](https://github.com/beto-sudo/BSOP/pull/1018), sin auto-merge — UI). Sigue **Sprint 2** (folio secuencial `OC-2026-0001` + PDF de la OC). Sprint 0 (#1017) ya mergeado.
**Dueño:** Beto
**Creada:** 2026-06-24
**Última actualización:** 2026-06-24 (Sprint 1 en PR #1018: panorama y filtros — sin auto-select + estado/fecha + columna y búsqueda por proyecto + export CSV; Sprint 0 #1017 mergeado)
