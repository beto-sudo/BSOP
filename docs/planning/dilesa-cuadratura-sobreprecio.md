...
**Estado:** in_progress
**Próximo hito:** (1) Resolver las 3 anomalías DB↔PDF pendientes (M10-L8, M12-L9, M12-L33) cuando Beto pueda revisarlas (Reminder en `Claude 🧭`). (2) Construir la **raíz** = flujo de asignación que persiste el desglose al asignar (para que las ventas nuevas nazcan pobladas).
**Dueño:** Beto
**Creada:** 2026-06-17
**Última actualización:** 2026-06-18 (cuadratura desglosada completa en prod: 88 pobladas, fase 10 muestra el pagaré #944, editor de descuentos por modelo #945; pendientes = 3 anomalías + la raíz)
