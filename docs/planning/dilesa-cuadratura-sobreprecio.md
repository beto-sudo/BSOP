...
**Estado:** in_progress
**Próximo hito:** (1) Edgar llena el Google Sheet de las 101 activas → re-import a prod (con OK explícito de Beto). (2) Construir la **raíz** = flujo de asignación que persiste el desglose (precio_base, incremento, promoción) al asignar. Motor+UI ya en [PR #938](https://github.com/beto-sudo/BSOP/pull/938) (abierto, revisión de Beto).
**Dueño:** Beto
**Creada:** 2026-06-17
**Última actualización:** 2026-06-17 (tarde) (motor+UI coherente #938; MAYRA aprobada; modelo unificado 2-param confirmado; tabla de Edgar construida para poblar las 101 activas)
