...
**Estado:** in_progress
**Próximo hito:** (1) OK de Beto para poblar las 86 (script `populate_dilesa_desglose_precio.ts` listo, dry-run cuadra 86/86) + resolver las 6 anomalías DB↔PDF. (2) Construir la **raíz** = flujo de asignación que persiste el desglose al asignar.
**Dueño:** Beto
**Creada:** 2026-06-17
**Última actualización:** 2026-06-18 (geometría desglosada exacta de los PDFs: migración 4 cols + motor/UI + script de poblado; 86 listas, 6 anomalías a revisar)
