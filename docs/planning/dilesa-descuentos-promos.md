...
**Estado:** in_progress
**Próximo hito:** Sprint 3 — tope estricto (`nativa-sin-promo → 0`), una vez que el catálogo esté poblado con las promos que correspondan.
**Dueño:** Beto
**Creada:** 2026-06-15
**Última actualización:** 2026-06-16 (Sprint 2 — catálogo de promociones CRUD + auto-asignación — en CI; migración del sub-slug aplicada a prod)
