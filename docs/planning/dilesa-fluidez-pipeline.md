...
**Estado:** in_progress
**Próximo hito:** **S2b** — banda de fluidez por venta en la lista y el expediente (R2), usando el benchmark de S2a; + S2a.2 (PDF del reporte y segmentación por crédito/proyecto). (S2a entregado: radar «Calificación por fase» con corte temporal.)
**Dueño:** Beto
**Creada:** 2026-06-28
**Última actualización:** 2026-06-29 (S2a: radar «Calificación por fase» — benchmark por fase + RPC con corte temporal + reporte)
