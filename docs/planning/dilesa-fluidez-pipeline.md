...
**Estado:** in_progress
**Próximo hito:** **S3** — metas editables por fase (Dirección) que sustituyen la mediana histórica como vara; + S2a.2 (PDF del reporte, segmentación crédito/proyecto) y confirmar la clasificación interna/tercero de `responsableFase`. (S2a+S2b entregados.)
**Dueño:** Beto
**Creada:** 2026-06-28
**Última actualización:** 2026-06-29 (S2b: banda de fluidez por venta — días contextualizados por benchmark + columna Fluidez ordenable)
