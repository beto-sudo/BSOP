...
**Estado:** in_progress
**Próximo hito:** Beto revisa el preview del Sprint 3a (Escrituración programada + Por tipo de crédito). Luego Sprint 3b (Inventario disponible + Ventas estancadas — cierran los 7 reportes de Ventas) sobre loaders nuevos (unidades, venta_fases).
**Dueño:** Beto
**Creada:** 2026-06-19
**Última actualización:** 2026-06-20 (Sprints 1 #965 y 2 #966 mergeados; migración RBAC aplicada a prod; Sprint 3a construido — Escrituración programada + Por tipo de crédito; en preview)
