...
**Estado:** in_progress
**Próximo hito:** Beto revisa el preview de #967 (Escrituración programada con fix + Por tipo de crédito + Inventario disponible). Falta el último reporte: Ventas estancadas (loader de `venta_fases` para días sin avanzar de fase) → cierra los 7 de Ventas.
**Dueño:** Beto
**Creada:** 2026-06-19
**Última actualización:** 2026-06-20 (Sprints 1 #965 y 2 #966 mergeados; migración RBAC aplicada a prod; #967 con Escrituración programada [+fix de filtro] + Por tipo de crédito + Inventario disponible — 6/7 reportes; en preview)
