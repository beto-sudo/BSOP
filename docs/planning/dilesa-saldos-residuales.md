...
**Estado:** in_progress
**Próximo hito:** Cierre — mergear S2 (bloqueado por drift heredado: prod tiene `estimacion_id` de #1043 sin mergear → rebase cuando aterrice) y, con OK de Beto tras revisar, marcar la iniciativa `done`.
**Dueño:** Beto
**Creada:** 2026-06-25
**Última actualización:** 2026-06-25 (Sprint 2 — pagaré del residual de precio + reconciliación en F13 + addendum ADR-048; en PR, código verde, merge en espera de #1043)
