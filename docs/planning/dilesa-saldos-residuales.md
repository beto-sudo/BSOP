...
**Estado:** in_progress
**Próximo hito:** Sprint 2 — reconciliación de la NC en F13 (el CFDI de NC ≥ lo absorbido + lo derivado) + pagaré formal del residual de precio (camino "Cobrar": asignación gastos↔precio en el motor para reusar `<CreditoDirectoCaptura>`) + addendum a ADR-048.
**Dueño:** Beto
**Creada:** 2026-06-25
**Última actualización:** 2026-06-25 (S1 en prod — #1040 mergeado, migración aplicada y ledger reconciliado; el control de resolución + gate ya operan en la dictaminación)
