...
**Estado:** in_progress
**Próximo hito:** Sprint 1 en [PR #948](https://github.com/beto-sudo/BSOP/pull/948) (CI verde) + migración de sub-slugs **ya aplicada a prod** (8 roles c/u = `dilesa.ventas.lista`, ledger reconciliado) — Beto: revisar Vercel preview y mergear. Luego Sprint 2: Pipeline + Estado de cuenta a tab propio + reconciliar `<CapturarFaseHeader>`.
**Dueño:** Beto
**Creada:** 2026-06-18
**Última actualización:** 2026-06-18 (Sprint 1 completo; 6 checks verdes; migración aplicada a prod; PR #948 por revisar/mergear)
