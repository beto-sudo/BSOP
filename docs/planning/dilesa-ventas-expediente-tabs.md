...
**Estado:** in_progress
**Próximo hito:** Sprint 1 mergeado (#948, en prod). Sprint 2 (Pipeline + Estado de cuenta a tab propio → 6 tabs) en PR — CI + migración de los 2 sub-slugs. Tras merge, la iniciativa cubre su objetivo; queda opcional un Sprint 3 de pulido (loading por tab, deep-links a tab desde copiloto/banners, manual in-app).
**Dueño:** Beto
**Creada:** 2026-06-18
**Última actualización:** 2026-06-18 (Sprint 1 en prod; Sprint 2 completo en local — 6 tabs, 6 checks verdes; PR S2 por revisar/mergear)
