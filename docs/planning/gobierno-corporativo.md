...
- **Sprint 4 — Seed DILESA + closeout**:
  ...
  - [x] **4d · Consejo completo** ✅ — sembrado el consejo de **19 miembros** de Acta 34 (`scripts/import_gobierno_consejo_dilesa.ts`): Gerardo presidente + Urbano secretario (vitalicios, con voto) + Adalberto tesorero + 16 vocales, mapeados a su socio/familia. Voto de CHC asignado a María Josefina Cruz Santos (por confirmar). Comité directivo intacto.
  - [x] **Closeout** ✅ — Beto cerró la iniciativa ("por lo pronto") 2026-06-02; movida a `done` en INITIATIVES. Sin reminders propios que barrer. **Seguimiento no bloqueante de Beto** (editable en la UI, no reabre la iniciativa): día exacto del reglamento; confirmar voto de CHC (inferido a María Josefina Cruz Santos); el consejo de 19 **excede el máx. 8 del Reglamento** (realidad legal del acta vs política — decisión de Beto); acta 1 sin PDF correcto (el del folder es de 2013, no el APERTURA 2003) + 8 actas (4,6-10,16,19) sin escaneo.
...
- **2026-06-02 (Sprint 4d)** — A pedido de Beto, sembrado el **consejo de administración completo** (19 miembros) según Acta 34 (10-ago-2022, ratifica Acta 32/2021) vía `scripts/import_gobierno_consejo_dilesa.ts` (borra+reinserta `organo='consejo'`, comité directivo intacto): Gerardo Santos Benavides (presidente, voto, vitalicio), Urbano Santos Benavides (secretario, voto, vitalicio), Adalberto Santos de los Santos (tesorero) + 16 vocales mapeados a su socio. Voto de CHC asignado a María Josefina Cruz Santos (representante de CHC — por confirmar). Verificado en prod: 19 consejo (3 voto, 2 vitalicios) + 3 comité. Nota: 19 > máx. 8 del Reglamento (realidad legal del acta vs política) — para decisión de Beto.
