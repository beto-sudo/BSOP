...
- **Sprint 4 — Seed DILESA + closeout**:
  ...
  - [ ] **Closeout** — verificación de Beto: día exacto del reglamento; confirmar voto de CHC (María Josefina Cruz Santos); el consejo de 19 **excede el máx. 8 del Reglamento** (realidad legal vs política — decisión de Beto); revisar acta 1 (PDF del folder es de 2013, no del APERTURA 2003). Mover a `done` en INITIATIVES cuando Beto confirme.
