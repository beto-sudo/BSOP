...
**Estado:** in_progress
**Próximo hito:** S2 — **3 violaciones WCAG críticas resueltas** (button-name de los Refresh de Tareas/Empresas + label del input de fecha "Al corte" del inventario RDB; aria-labels, cero cambio visual). **Pendiente:** (a) **color-contrast** (serious, sistémico: textos con opacidad `/40`–`/50` sin contraste AA) → decisión de diseño de Beto sobre los tokens; (b) los 5 smoke de RDB de S1 (pulido pantalla-por-pantalla).
**Dueño:** Beto
**Creada:** 2026-06-26
