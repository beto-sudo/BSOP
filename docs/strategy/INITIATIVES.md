...
>
> **Última actualización:** 2026-04-27 (`proveedores-csf-ai` Sprint 1.A mergeable — migración DB aplicada [PR #235], `erp.personas_datos_fiscales` + `tipo_persona` en producción. Estado `planned → in_progress`, próximo hito = Sprint 1.B endpoint extract-csf.)
