...
| Empleados multi-puesto      | `empleados-multi-puesto`   | todas    | erp + UI                    | in_progress | Sprint 2 — refactor backend para leer puestos vía vista/N:M y migrar wizard de alta. Sprint 1 cerrado (tabla `empleados_puestos` + backfill + ADR-013).  | 2026-04-27           |
