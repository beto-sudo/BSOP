...
export const TIPOS_ACTIVO = [
  ...
  { value: 'espacio_publicitario', label: 'Espacio publicitario' },
...
export const SATELITE_FIELDS: Record<string, readonly ActivoFieldDef[]> = {
  ...
  espacio_publicitario: [
    {
      ...
      options: [
        ...
        { value: 'padel', label: 'Cancha de padel' },
        { value: 'valla', label: 'Valla' },
        { value: 'otro', label: 'Otro' },
      ] as const,
      section: 'Espacio publicitario',
    },
    {
      key: 'vialidad',
      label: 'Vialidad / ubicación',
      type: 'text',
      section: 'Espacio publicitario',
    },
    { key: 'caras', label: 'Número de caras', type: 'number', section: 'Espacio publicitario' },
    { key: 'orientacion', label: 'Orientación', type: 'text', section: 'Espacio publicitario' },
    { key: 'ancho_m', label: 'Ancho (m)', type: 'number', section: 'Espacio publicitario' },
    { key: 'alto_m', label: 'Alto (m)', type: 'number', section: 'Espacio publicitario' },
    { key: 'iluminado', label: 'Iluminado', type: 'checkbox', section: 'Espacio publicitario' },
    {
    ...
    {
      key: 'anunciante_actual',
      label: 'Anunciante actual',
      type: 'text',
      section: 'Espacio publicitario',
    },
    {
  ...
  lote: [
    ...
    { key: 'calle', label: 'Calle', type: 'text', section: 'Lote' },
    { key: 'numero_oficial', label: 'Número oficial', type: 'text', section: 'Lote' },
    { key: 'es_esquina', label: 'Esquina', type: 'checkbox', section: 'Lote' },
    { key: 'tiene_frente_verde', label: 'Frente a área verde', type: 'checkbox', section: 'Lote' },
