...
- titulo (text)
- descripcion (text)
- asignado_a (uuid, FK erp.empleados)
- asignado_por (uuid, FK erp.empleados)
- creado_por (uuid, FK core.usuarios)
- prioridad_id (uuid, FK shared.prioridades)
- estado (text: pendiente, en_progreso, bloqueado, completado, cancelado)
- fecha_vence (date)
- fecha_completado (timestamptz)
- completado_por (uuid, FK erp.empleados)
...
- autor_id (uuid, FK core.usuarios)
- contenido (text)
- created_at (timestamptz)
