...
BEGIN
  ...
  IF v_id IS NOT NULL THEN
    ...
    WHERE id = v_id
    RETURNING id, corte_nombre, estado INTO v_id, p_corte_nombre, p_estado;
  ...
  ELSE
    INSERT INTO caja.cortes (
      coda_id, corte_nombre, caja_nombre, estado, turno,
      ...
      p_coda_id, p_corte_nombre, p_caja_nombre, p_estado, p_turno,
