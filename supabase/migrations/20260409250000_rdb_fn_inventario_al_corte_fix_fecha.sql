-- EDITED 2026-04-23 (drift-1.5): same ambient-table guards as previous fn.
-- Fix: usar columna `fecha` (fecha real del movimiento) en lugar de `created_at`
-- (fecha de inserción del backfill).
